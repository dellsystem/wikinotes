...
md = markdown.Markdown(extensions=['mentions', 'wiki_footnotes', 'wiki_toc', 'downheader', 'wiki_tables', 'wiki_codehilite', 'wiki_fenced_code', 'wiki_def_list', 'nl2br', 'subscript', 'superscript', 'mathjax', 'urlize', 'wikilinks'], safe_mode='escape', output_format='xhtml1')
