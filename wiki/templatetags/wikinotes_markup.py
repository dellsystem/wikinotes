...
md = markdown.Markdown(extensions=['fenced_code', 'downheader', 'subscript', 'superscript', 'urlize', 'nl2br', 'def_list', 'tables', 'mathjax', 'wiki_toc', 'footnotes'], safe_mode='escape', output_format='xhtml1')
