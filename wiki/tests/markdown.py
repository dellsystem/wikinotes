...
<p>You can find the source of our Markdown parser (which uses the python-markdown library and several extensions) in our <a href="https://github.com/dellsystem/wikinotes/blob/master/wiki/templatetags/wikinotes_markup.py">GitHub repository</a>. The markdown source for this page can be found <a href="https://github.com/dellsystem/wikinotes/blob/master/wiki/templates/help/formatting.md">within the repository</a> as well.</p>
<div class="toc">
<ul>
...
<h2 class="header" id="inline-elements"><span>1</span>Inline elements</h2>
<h3 class="header" id="emphasis"><span>1.1</span>Emphasis</h3>
<h4 class="header" id="bold"><span>1.1.1</span>Bold</h4>
...
<h4 class="header" id="italics"><span>1.1.2</span>Italics</h4>
...
<h4 class="header" id="underline"><span>1.1.3</span>Underline</h4>
...
<h3 class="header" id="links"><span>1.2</span>Links</h3>
<h4 class="header" id="standard-links"><span>1.2.1</span>Standard links</h4>
...
<h4 class="header" id="reference-style-links"><span>1.2.2</span>Reference-style links</h4>
...
<h4 class="header" id="automatic-linking"><span>1.2.3</span>Automatic linking</h4>
...
<h3 class="header" id="images"><span>1.3</span>Images</h3>
<h4 class="header" id="image-syntax"><span>1.3.1</span>Image syntax</h4>
...
<h4 class="header" id="policy-on-outside-images"><span>1.3.2</span>Policy on outside images</h4>
...
<h3 class="header" id="inline-code"><span>1.4</span>Inline code</h3>
...
<h3 class="header" id="subscript-and-superscript"><span>1.5</span>Subscript and superscript</h3>
...
<h2 class="header" id="block-elements"><span>2</span>Block elements</h2>
<h3 class="header" id="headers"><span>2.1</span>Headers</h3>
<h4 class="header" id="header-syntax"><span>2.1.1</span>Header syntax</h4>
...
<h4 class="header" id="alternative-syntax"><span>2.1.2</span>Alternative syntax</h4>
...
<h4 class="header" id="section-numbers"><span>2.1.3</span>Section numbers</h4>
<p>Automatic section numbering is automatic. You can't disable it. Sorry.</p>
<h4 class="header" id="mapping-to-html-headers"><span>2.1.4</span>Mapping to HTML headers</h4>
...
<h3 class="header" id="paragraphs"><span>2.2</span>Paragraphs</h3>
<p>Surround a block of text with empty lines (or just nothing) before and after it and bam, paragraph.</p>
<h3 class="header" id="tables"><span>2.3</span>Tables</h3>
<h4 class="header" id="creating-a-table"><span>2.3.1</span>Creating a table</h4>
<p>A basic example:</p>
...
<h4 class="header" id="allowing-sorting"><span>2.3.3</span>Allowing sorting</h4>
...
<h4 class="header" id="changing-the-colour-scheme"><span>2.3.4</span>Changing the colour scheme</h4>
...
<h3 class="header" id="blockquotes"><span>2.4</span>Blockquotes</h3>
<p>Same as in <a href="http://daringfireball.net/projects/markdown/syntax#blockquote">regular markdown</a>. You can nest them, and add other block elements as well. For example:</p>
<div class="codehilite"><pre>&gt; This is a blockquote
...
<p>Back to the original blockquote</p>
</blockquote>
<h3 class="header" id="lists"><span>2.5</span>Lists</h3>
<p>Same as in <a href="http://daringfireball.net/projects/markdown/syntax#list">standard markdown</a>. To create an unordered list, you can use *, +, or - as the list delimiters. For example:</p>
<div class="codehilite"><pre>* List item one
* List item two
* List item spanning
multiple lines
* Last list item
...
<li>List item one</li>
<li>List item two</li>
<li>List item spanning<br />
multiple lines</li>
<li>Last list item</li>
</ul>
<p>You can create ordered lists simply by numbering your list items. The numbers don't have to be in order, but it's probably better if they are. For example:</p>
<div class="codehilite"><pre>1. List item one
2. List item two
...
<h3 class="header" id="code-blocks"><span>2.6</span>Code blocks</h3>
<h4 class="header" id="tabbed-code-blocks"><span>2.6.1</span>Tabbed code blocks</h4>
...
<h4 class="header" id="fenced-code-blocks"><span>2.6.2</span>Fenced code blocks</h4>
...
<h4 class="header" id="syntax-highlighting"><span>2.6.3</span>Syntax highlighting</h4>
...
<h4 class="header" id="line-numbers"><span>2.6.4</span>Line numbers</h4>
...
<h3 class="header" id="horizontal-rules"><span>2.7</span>Horizontal rules</h3>
...
<h3 class="header" id="definition-lists"><span>2.8</span>Definition lists</h3>
...
<h3 class="header" id="footnotes"><span>2.9</span>Footnotes</h3>
...
<h3 class="header" id="line-breaks"><span>3.1</span>Line breaks</h3>
...
<h3 class="header" id="escaping-things"><span>3.4</span>Escaping things</h3>
