...
class TestMarkdown(unittest.TestCase):
	...
	expected = {
		...
		'code_tabbed'				: 
									...
									'</pre></div>'
									,
		'h2'						: '<h3 class="header"><span>1</span>header2 text<a class="headerlink" name="header2-text" href="#header2-text">&para;</a></h3>'
									,
		'h3'						: '<h4 class="header"><span>1</span>header3 text<a class="headerlink" name="header3-text" href="#header3-text">&para;</a></h4>'
									,
		'image'							: '<p><img alt="alt" src="http://beta.wikinotes.ca/static/img/logo.png" title="title" /></p>'
									,
		'h1'						: '<h2 class="header"><span>1</span>header1 text<a class="headerlink" name="header1-text" href="#header1-text">&para;</a></h2>'
									,
		'reflink'					: ''
									,
		'h4'						: '<h5 class="header"><span>1</span>header4 text<a class="headerlink" name="header4-text" href="#header4-text">&para;</a></h5>'
									,
		'h5'						: '<h6 class="header"><span>1</span>header5 text<a class="headerlink" name="header5-text" href="#header5-text">&para;</a></h6>'
									,
		...
		'code_highlight1'				: 
									...
									'</pre></div>'
									,
		'alth1'				: '<h3 class="header"><span>1</span>header text<a class="headerlink" name="header-text" href="#header-text">&para;</a></h3>'
									,
		'alth2'				: '<h2 class="header"><span>1</span>header text<a class="headerlink" name="header-text" href="#header-text">&para;</a></h2>'
									,
		'table_align'				: 
									'<table>\n'
									'<thead>\n'
